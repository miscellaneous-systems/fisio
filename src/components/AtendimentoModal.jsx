...
import { ClipboardList, TrendingUp, Printer, ArrowLeft, X } from "lucide-react";
          ...
          {mode === "menu" && (
            <div className={styles.menuOptions}>
              <p className={styles.instruction}>
                Selecione o tipo de registro para iniciar:
              </p>
              <button
                className={`${styles.menuBtn} ${styles.btnAvaliacao}`}
                onClick={() => setMode("avaliacao")}
              >
                <div className={styles.menuBtnHeader}>
              ...
              <button
                className={`${styles.menuBtn} ${styles.btnEvolucao}`}
                onClick={() => setMode("evolucao")}
              >
                <div className={styles.menuBtnHeader}>
                  <TrendingUp size={22} />
                  <strong>Iniciar Evolução</strong>
                </div>
            ...
            <div className={styles.formContainer}>
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  placeholder="O que trouxe o paciente aqui?"
                />
              </div>
              <div className={styles.formGroup}>
                <label>História da Moléstia Atual (HMA)</label>
                <textarea
                  value={avaliacaoData.hma}
                  onChange={(e) =>
                    setAvaliacaoData({ ...avaliacaoData, hma: e.target.value })
                  }
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  type="text"
                  value={avaliacaoData.diagnostico}
                  onChange={(e) =>
                    setAvaliacaoData({
                      ...avaliacaoData,
              ...
              <div className={styles.actions}>
                ...
                <div className={styles.rightActions}>
                  <button
                    onClick={() =>
                      handlePrint("Avaliação Inicial", getAvaliacaoContent())
                    }
          ...
          {mode === "evolucao" && (
            <div className={styles.formContainer}>
              ...
              <div className={styles.formGroup}>
                ...
                <textarea
                  rows="6"
                  value={evolucaoData.relato}
                  onChange={(e) =>
                    setEvolucaoData({ ...evolucaoData, relato: e.target.value })
                  }
                  placeholder="Como o paciente reagiu? O que foi feito?"
                />
              </div>
              <div className={styles.formGroup}>
                ...
                <textarea
                  ...
                  placeholder="Orientações para casa ou plano para próxima sessão..."
                />
              </div>
              ...
              <div className={styles.actions}>
                ...
                <div className={styles.rightActions}>
                  <button
                    onClick={() =>
                      handlePrint("Evolução de Sessão", getEvolucaoContent())
                    }
                    className={styles.printBtn}
                  >
                    <Printer size={16} /> Imprimir
